...
/* stores white list data in-memory, maintained as global ds*/ 
...
extern int scan(struct file *filp, struct file_data *fdata,
...
extern int scan_black_list(int src_offset, struct file_data *fdata,
			   struct virus_def *vir_def);
